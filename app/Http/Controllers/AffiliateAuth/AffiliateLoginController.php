...
class AffiliateLoginController extends Controller
{
	...
	use AuthenticatesUsers, PublishedPageTrait;
    ...
    {
		$this->middleware('guest:affiliateusers')->except('logout');
		// $this->middleware('affiliateusers')->except('logout');
    }

    public function showLoginForm()
    {
        return Inertia::render('hypershapes-affiliate/pages/Login');
    }
    ...
    {
		// dd($this->guard()->attempt($this->credentials($request), $request->filled('remember')));

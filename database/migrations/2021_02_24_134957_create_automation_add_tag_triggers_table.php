...
class CreateAutomationAddTagTriggersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('automation_add_tag_triggers', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('automation_add_tag_triggers');
    }
}

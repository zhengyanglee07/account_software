...
class CreateReferralCampaignActionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('referral_campaign_actions', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('referral_campaign_actions');
    }
}

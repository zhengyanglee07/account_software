...
class DropExistsThenCreateAffiliateMemberReferralsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::create('affiliate_member_referrals', function (Blueprint $table) {
            ...
            $table->foreign('affiliate_member_participant_id', 'affiliate_member_referrals_participant_id')->references('id')->on('affiliate_member_participants')->onDelete('cascade');

...
export default {
  ...
  setup() {
    ...
    const navigations = ref([
      {
        title: 'Dashboard',
        link: '/affiliates/dashboard',
        iconURL: 'dashboard-icon.svg',
      },
      {
        title: 'Campaigns',
        link: '/affiliates/campaigns',
        iconURL: 'affiliate-icon.svg',
      },
      {
        title: 'Conversions',
        link: '/affiliates/conversions',
        iconURL: 'orders-icon.svg',
      },
      {
        title: 'Payouts',
        link: '/affiliates/payouts',
        iconURL: 'marketing-icon.svg',
      },
      {
        title: 'Profile',
        link: '/affiliates/profile',
  ...
  computed: {
    affiliateMemberName() {
      return this.$page.props.affiliateMemberName;
    },
  ...
  methods: {
    logout() {
      localStorage.clear();
      return this.$inertia.get('/affiliates/logout');
    },
  },
};
</script>

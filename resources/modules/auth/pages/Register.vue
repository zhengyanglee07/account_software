<template>
  ...
  <div
    class="mt-3"
    style="text-align: center; margin-bottom: 22.75px; font-weight: 500"
  >
    <span
      class="p-two"
      style="
  ...
  <div class="container w-100">
    <form @submit.prevent="submit">
      <div class="form-group">
        <div class="row">
          <div class="col-md-6">
            <div class="inputContainer__row inputContainer__row--col-left">
              ...
              <!-- <BaseFormGroup
                      ...
                      >
                        <BaseFormInput
                          ...
                          name="firstName"
                          type="text"
                          v-model:model-value="form.fName"
                        />
                      </BaseFormGroup> -->
              <!-- <label
                        class="inputContainer__label h-five"
                      >First Name</label>
                      <input
                        id="firstName"
                        v-model="form.fName"
          ...
          <div class="col-md-6">
            <div
              class="inputContainer__row inputContainer__row--col-right text-start"
            >
              ...
              <!-- <BaseFormGroup
                      ...
                      >
                        <BaseFormInput
                          ...
                          name="lastName"
                          type="text"
                          v-model:model-value="form.lName"
                        />
                      </BaseFormGroup> -->
              <!-- <label
                        class="inputContainer__label h-five"
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="inputContainer__row text-start">
              ...
              <!-- <label class="inputContainer__label h-five">Email</label>
                      <input
                        id="email"
                        v-model="form.email"
                        name="email"
              ...
              <!-- <span
                        v-if="errors.email"
                        class="error-message error-font-size failed"
                      >
                        {{ errors.email }}
                      </span> -->
            </div>
          ...
          <div v-else>
            ...
            >
              <div class="spinner--white-small">
                <div class="loading-animation loading-container m-0">
...
// const validateCheck = (emailAddress) => {
//   axios
//     .post('register/check', {
//       'email': emailAddress,
//     })
...
//         className.value = data.isExisted ? 'input-danger' : 'input-success';
//         isEmailExisted.value = data.isExisted;
...
//           isEmailExisted.value = true;
//           emailMessage.value = 'Please enter valid email address';
//           className.value = 'input-danger';
//         } else if (filter.test(email.value)) {
//           isCheckingEmail.value = false;
//           validateCheck(email.value);
//         }
//       } else if (email.value.trim().length === 0) {
//         emailMessage.value = 'Email address is required';
//         className.value = 'input-danger';
//       } else {
//         emailMessage.value = '';
//         className.value = '';
...
//         .then((response) => {
//           console.log('success')
//           this.$toast.success('Success', 'Register Successfully.');
//           this.$inertia.visit('/confirm/email');
//         })
//         .catch((error) => {
//           password.value = '';

<template>
  <div class="row mt-3">
    <div class="col-md-12">
          ...
          <div class="input-group">
            ...
            <div class="browse-wrapper-input">
              <input
                ...
                :data-target="'#browseProductModal'"
      ...
      >
        <li
          v-for="(product, index) in showSelectedProduct"
          :key="index"
          class="_19Fmu"
        >
          <div class="_3sTAJ">
    ...
    <BrowseProductModal
      ...
      :button-title="selectedProduct.length > 0 ? 'Done' : 'Add'"
      :all-products="allProducts"
      :currency="currencyDetails.currency"
      :selected-product="selectedProduct"
      @save="updateSelectedProduct"
    />
  </div>
</template>
...
export default {
  ...
  props: ['allProducts', 'currencyDetails', 'selectedProduct'],
    ...
    selectedProduct: {
      ...
      handler(newValue) {
        ...
        newValue.forEach((id) => {
          ...
          this.showSelectedProduct.push(selectedItem);
        });
      },
    },
  },
  mounted() {
    this.selectedId = this.selectedProduct;
  },

  methods: {
    showModal() {
      new Modal(document.getElementById('browseProductModal')).show();
    },
    removeProduct(id) {
